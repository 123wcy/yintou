<template>
    <div class="content-container">
        ...
        <div class="table-display">
            ...
            >
                ...
                <tr class="tr">
                    ...
                    <td style="width:115px">报告名称</td>
                    <td style="width:147px">提交时间</td>
                    <td style="width:111px">提交单位</td>
                    <td style="width:110px">资料状态</td>
                    <td style="width:141px">资料审核</td>
                </tr>
                <table>
                    <tr v-for="(report,index) in creditreportData" :class="{'white':index%2 != 0}">
                        ...
                        <td style="width:113px">{{report.name}}</td>
                        ...
                        <td style="width:139px"><el-button type="primary" plain @click="addFormVisible = true">初审</el-button>
                            <el-button type="warning" plain @click="handleEdit(scope.row)">终审</el-button></td>
                    </tr>
                </table>
        ...
        <el-dialog :visible.sync="addFormVisible" title="确认初审">
            <form  class="form">
                确认初审通过
            </form>
